...
class LdaMallet(utils.SaveLoad, basemodel.BaseTopicModel):
    ...
    """
    def __init__(self, mallet_path, corpus=None, num_topics=100, alpha=50, beta_path=None, id2word=None, workers=4, prefix=None,
    ...
    def train(self, corpus):
        ...
        # If beta is a file, use `--beta-file`, otherwise use scalar `--beta`
        if isinstance(self.beta_path, str):  
            cmd += ' --beta-file %s' % self.beta_path
