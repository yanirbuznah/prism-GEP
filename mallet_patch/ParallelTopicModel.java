...
public class ParallelTopicModel implements Serializable {
	...
	public static void main (String[] args) {
		...
		try {
			...
			// Third arg is the informed beta-prior CSV produced by the PRISM-GEP pipeline.
			ParallelTopicModel lda = new ParallelTopicModel (topicAlphabet, 50.0, "priors/beta_prism.csv");
